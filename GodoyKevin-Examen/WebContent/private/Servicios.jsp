...
<body id="home-section" style="background-image: url('https://wallpaperaccess.com/full/834932.jpg');">

<form style="display: none;" id="form_cbr" action="/GodoyKevin-Examen/ServletCabacera" method="post">
		...
		<div class="container bg-light shadow fixed-top">
			<div class="row align-items-center">
				...
				<div style="float: left; margin-right: auto;">
					<h1 class="mb-0 site-logo"><a class="h2 mb-0" style="margin-left: 5px;">Mi Agenda<span
				...
				<nav class="navbar navbar-expand-lg navbar-light bg-light">
					...
					<div class="collapse navbar-collapse" id="navbarNav">
						<ul class="navbar-nav nav nav-tabs" style="padding:64px">
							<li class="nav-item">
							...
							<li class="nav-item">
								<a class="nav-link" href="/GodoyKevin-Examen/ServletIMG?salir=true">Cerrar Sesion</a>
							</li>
						</ul>
					</div>
				</nav>
	...
	<section class="site-section" style="margin-top: 55px;">
		<div class="container">
			...
			<div class="form-submit">
				<form id="form_cabecera" action="/GodoyKevin-Examen/ServletBusquedas" method="post" style="margin-left:400px">
					<h5 style="color: white" , class="bg-black"><strong style="font: initial;color: black;">Listar Telefonos Por Cedula:</strong></h5>
			...
			<div class="row hover-1-wrap mb-5 mb-lg-0 overflow-auto" style="
    margin-left: 400px;
    margin-top: -45px;
">
				<div class="col-lg-2">
...
">
			...
			<div class="form-submit">
				<form action="/GodoyKevin-Examen/ServletCrtUpt" method="post">
			...
			<div class="border-top">
				<p class="copyright">
					Copyright &copy; 2020. Designed <i class="icon-heart text-danger" aria-hidden="true"></i> by <a
						href="" target="_blank">Kevin Godoy</a>
